                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="row">
                        <div class="form-group">
                            <span id="FAKEH1">Meus dados</span>
                            <a  href="{{ url('dashboard/perfil/'.$u->id.'/editar')}}">
                                <x-button style="margin-left:85%;" type="submit">
                                    Editar dados
                                </x-button>
                            </a>
                        </div>
                        ...
                        <table style="margin-top: 50px; width: auto;">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td id="td-vertical"><b>Cep: </b>{{ ''.$u->cep.','}} <b>Cidade: </b>{{''.$u->cidade.','}} <b>Bairro: </b> {{''.$u->bairro.','}} <b>Rua: </b> {{''.$u->rua.','}} <b>Bairro: </b> {{''.$u->bairro.','}} <b>Nº: </b>{{''.$u->numero }}</td>
                                </tr>
                            </thead>
                        </table>
                    </div>
